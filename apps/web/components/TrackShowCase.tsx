      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {tracks.map((track) => (
          ...
          >
            ...
            <button className="w-full transform rounded-lg bg-blue-600 px-4 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-blue-700">
              Try Demo
            </button>
          </div>
        ))}
